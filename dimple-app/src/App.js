...
//       <header>
//         <h1>Dimple Check</h1>
//         <p>Upload a photo to screen for Normal / Abnormal.</p>
//       </header>
...
//   const guide = guidanceText(label, tag);   // English guidance text
...
//     if (tag === 'Medium') return 'Close to the threshold. Interpret together with clinical findings.';
